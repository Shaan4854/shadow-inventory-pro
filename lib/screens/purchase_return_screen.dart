...
class _PurchaseReturnScreenState extends State<PurchaseReturnScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: _originalTransaction == null ? _TransactionPicker(onSelected: _selectTransaction, type: TransactionType.purchase) : _ReturnForm(
            ...
            child: Column(
              ...
              children: [
                Row(
                  ...
                  children: [
                    const Text('Original Transaction', style: TextStyle(fontWeight: FontWeight.bold)),
                    TextButton(onPressed: onCancel, child: const Text('Change')),
                  ],
                ),
                Text('Supplier: ${original.entityName}', style: TextStyle(color: AppConstants.colors.textSecondary)),
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text('Purchased: ${originalItem.quantity}', style: TextStyle(fontSize: 12, color: AppConstants.colors.textMuted)),
                            ],
                          ),
                        ),
                        _QuantitySelector(
